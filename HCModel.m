                        ...
                        switch colors(i)
                            case 0
                                if getRegion(targets(j),regions) == getRegion(i,regions)
                                    plot3([m2(1),pt(1)],[m2(2),pt(2)],[m2(3),pt(3)],'k')
                                else
                                    plot3([br(1),pt(1)],[br(2),pt(2)],[br(3),pt(3)],'k')
                                end
                            case 1
                                if getRegion(targets(j),regions) == getRegion(i,regions)
                                    plot3([m2(1),pt(1)],[m2(2),pt(2)],[m2(3),pt(3)],'r')
                                else
                                    plot3([br(1),pt(1)],[br(2),pt(2)],[br(3),pt(3)],'r')
                                end
                            case 2
                                if getRegion(targets(j),regions) == getRegion(i,regions)
                                    plot3([m2(1),pt(1)],[m2(2),pt(2)],[m2(3),pt(3)],'g')
                                else
                                    plot3([br(1),pt(1)],[br(2),pt(2)],[br(3),pt(3)],'g')
                                end
                            case 3
                                if getRegion(targets(j),regions) == getRegion(i,regions)
                                    plot3([m2(1),pt(1)],[m2(2),pt(2)],[m2(3),pt(3)],'c')
                                else
                                    plot3([br(1),pt(1)],[br(2),pt(2)],[br(3),pt(3)],'c')
                                end
                        end
                        %{
                        if getRegion(targets(j),regions) == getRegion(i,regions)
