function ModelGen(trialnum, showNode, display)
...
%trialnum = trial; %trials in z_coords, pick one
%figure
%imshow(img), hold on
...
filepath = sprintf('trial%d.mat', trialnum);
load(filepath);
        ...
        for i=1:122
            switch states(i)
                case 0
                    ...
                    switch randcolor
                        case 1
                            h1 = plot3(full(i,2),full(i,3),full(i,4), 'r.', 'MarkerSize',40);
                            hold on
                        case 2
                            h2 = plot3(full(i,2),full(i,3),full(i,4), 'g.', 'MarkerSize',40);
                            hold on
                        case 3
                            h3 = plot3(full(i,2),full(i,3),full(i,4), 'b.', 'MarkerSize',40);
                            hold on
                    end
                case 1
                    h4 = plot3(full(i,2),full(i,3),full(i,4), 'k.', 'MarkerSize',40);
                    hold on
            end
        end
        imshow(img), hold on, axis on, grid on
